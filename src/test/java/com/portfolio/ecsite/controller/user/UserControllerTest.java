...
class UserControllerTest {
    ...
    class ControllerTest {
        ...
        @Test @Order(2) @DisplayName("ユーザー登録画面のアクセス")
        ...
        @Test @Order(3) @DisplayName("登録ボタン押下後、ユーザ一覧画面にリダイレクトする")
        void createUser() {
        }


        @Test @Order(4) @DisplayName("ユーザー編集画面のアクセス")
        ...
        @Test @Order(5) @DisplayName("ユーザー編集エラー画面のアクセス")
        ...
        @Test @Order(6) @DisplayName("編集ボタン押下し、ユーザー一覧画面にリダイレクトする")
        void updateUser() {
        }
    }
